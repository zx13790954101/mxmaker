  ...
  <div class="shopping-cart">
    ...
    <footer>
      ...
      <div class="right" @click="tosumbit">
        <span>优惠金额<el-input v-model="reduceMoneny" placeholder="请输入优惠金额"></el-input></span>
       ...
       $(that.goodList).each(function(index,element){
        ...
        that.$http.get(globalPath+'/ManageOrder', {
          params:{
            ...
            sendTime:0,
            backTime:0,
            orderMoney:(that.totalPrice2-that.reduceMoneny),
            goodMoney:that.totalPrice2,
            fasterMoney:0,
            cheapMoney:that.reduceMoneny,
            ...
            if(res=>0) {
              ...
              var data={
                  id:res.body,
                  moneny:(that.totalPrice2-that.reduceMoneny)
              }
