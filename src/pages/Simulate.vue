<template>
  <div class="simulate">
    ...
    <div class="right_goods">
      <good-select @curGoodList="setCurGoodList" :deleteUrl="deleteUrl"></good-select>
    </div>
    ...
    <el-dialog title="分享设置" :visible.sync="dialogFormVisible" :modal="false">
      <el-form :model="share">
        <div class="my_row">
          <img class="share_img" :src="'http://7xo8yg.com1.z0.glb.clouddn.com/'+shareImg" alt="">
        </div>
        <div class="my_row">
    ...
    <!-- 选择分享渠道 -->
    <share :url="shareUrl" :title="share.title" :img="'http://7xo8yg.com1.z0.glb.clouddn.com/'+shareImg"></share>
    <!-- 商品详情 -->
  ...
  export default {
    ...
    methods: {
      ...
      setDeleteUrl(url){
        ...
        console.log(url);
        var deleteIndex = '';
        if(url==that.sessionGoodUrl){
            sessionStorage.removeItem('curGood');
          that.curGoodList.shift();
            return;
        }
        this.deleteUrl='';
