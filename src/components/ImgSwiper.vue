  ...
  <div class="img-swiper">
    ...
    <swiper :options="swiperOption" ref="mySwiper" v-if="typeof(imgList.length)!='undefined'&&imgList.length!=0">
      ...
      <swiper-slide  v-for="(item,index) in imgList" key="index">
        ...
        <div class="box" :style="{'background-image':'url('+item+')'}">
          <div class="bar" @mouseenter="setTarget($event)" @click="setTarget($event)">
            ...
            <el-dropdown @command="handleCommand">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command="1">继续上传图片</el-dropdown-item>
                <el-dropdown-item command="2">删除当前图片</el-dropdown-item>
                <el-dropdown-item command="3">删除所有图片</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </div>
